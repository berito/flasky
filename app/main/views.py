...
from flask import render_template,  request, redirect, url_for, current_app, flash, abort, make_response
from flask_login import login_required, current_user
from flask_sqlalchemy import get_debug_queries

from app.auth.forms import EditProfileAdminForm
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Ypur profile has been updated.')
...
@main.route('/edi-profile/<int:id>', methods=['GET', 'POST'])
@login_required
@admin_required
...
def after_request(response):
    for query in get_debug_queries():
        if query.duration >= current_app.config['FLASKY_SLQW_DB_QUERY_TIME']:
